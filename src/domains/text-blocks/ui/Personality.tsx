...
import { selectAllPersonalityTextBlocks } from '../../../lib/redux/feature/text-blocks/selectors';
...
export function Personality() {
  ...
  const allTextBlocks = useAppSelector(selectAllPersonalityTextBlocks);
  ...
  useEffect(() => {
    ...
    dispatch(
      fetchTextBlocks({
        page: 1,
        limit: 100, // Fetch more items since we're showing them all in the sidebar
        searchTerm: '',
        orgSlug: org.slug,
